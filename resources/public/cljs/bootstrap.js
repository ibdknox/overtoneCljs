...
crate.core.create_elem = function(a, b) {
...
crate.core.elem_factory = function(a) {
  ...
  crate.core.dom_attr.call(null, c, cljs.core.merge.call(null, a, cljs.core.ObjMap.fromObject(["\ufdd0'crateId"], {"\ufdd0'crateId":cljs.core.swap_BANG_.call(null, crate.core.elem_id, cljs.core.inc)})));
...
overtoneinterface.client.main.button = function(a) {
  var b = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core.get.call(null, b, "\ufdd0'param"), c = cljs.core.get.call(null, b, "\ufdd0'action"), b = cljs.core.get.call(null, b, "\ufdd0'label"), a = crate.core.html.call(null, cljs.core.Vector.fromArray(["\ufdd0'a.button", cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'data-action", "\ufdd0'data-param"], {"\ufdd0'href":"#", "\ufdd0'data-action":c, "\ufdd0'data-param":a}), 
  b]));
  a.setAttribute("crateGroup", group__2974__auto____3545);
  return a
};
overtoneinterface.client.main.button.prototype._crateGroup = group__2974__auto____3545;
overtoneinterface.client.main.piano_notes = function() {
  return function b(c) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.truth_(cljs.core.seq.call(null, c))) {
          var d = cljs.core.first.call(null, c);
          return cljs.core.cons.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":cljs.core.str.call(null, d), "\ufdd0'action":"play-note", "\ufdd0'param":d}), b.call(null, cljs.core.rest.call(null, c)))
        }
        return null
      }
    })
  }.call(null, cljs.core.range.call(null, 40, 60))
}();
overtoneinterface.client.main.dub_notes = function() {
  return function b(c) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.truth_(cljs.core.seq.call(null, c))) {
          var d = cljs.core.first.call(null, c);
          return cljs.core.cons.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":cljs.core.str.call(null, d), "\ufdd0'action":"dub-note", "\ufdd0'param":d}), b.call(null, cljs.core.rest.call(null, c)))
        }
        return null
      }
    })
  }.call(null, cljs.core.range.call(null, 40, 80))
}();
overtoneinterface.client.main.dub_wobble = function() {
  return function b(c) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.truth_(cljs.core.seq.call(null, c))) {
          var d = cljs.core.first.call(null, c);
          return cljs.core.cons.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'label", "\ufdd0'action", "\ufdd0'param"], {"\ufdd0'label":cljs.core.str.call(null, "w", d), "\ufdd0'action":"dub-wobble", "\ufdd0'param":d}), b.call(null, cljs.core.rest.call(null, c)))
        }
        return null
      }
    })
  }.call(null, cljs.core.range.call(null, 0, 8))
}();
...
overtoneinterface.client.main.populate = function(a, b) {
  var c = cljs.core.seq.call(null, b);
  if(cljs.core.truth_(c)) {
    for(var d = cljs.core.first.call(null, c);;) {
      if(jayq.core.append.call(null, a, overtoneinterface.client.main.button.call(null, d)), d = cljs.core.next.call(null, c), cljs.core.truth_(d)) {
...
jayq.core.delegate.call(null, overtoneinterface.client.main.$body, overtoneinterface.client.main.button, "\ufdd0'click", function(a) {
  a.preventDefault();
  var b = jayq.core.$.call(null, this), a = jayq.core.data.call(null, b, "\ufdd0'action"), b = jayq.core.data.call(null, b, "\ufdd0'param"), b = cljs.core.truth_(cljs.core._EQ_.call(null, b, "")) ? cljs.core.Vector.fromArray([]) : cljs.core.Vector.fromArray([b]);
  return fetch.remotes.remote_callback.call(null, a, b)
});
